...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2021 a las 10:49:05
...
DECLARE ventas int;
SELECT COUNT(*) INTO usuarios FROM empleado;
...
WHILE a <= registros DO
    ...
    SET nueva_existencia = existencia_actual - 0;
...
CREATE TABLE `cliente` (
  ...
  `cliente_nombre` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `cliente_telefono` bigint(15) NOT NULL,
  `cliente_direccion` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `cliente_empleadoid` int(11) NOT NULL
...
-- INSERT INTO `cliente` (`cliente_id`, `cliente_dni`, `cliente_nombre`, `cliente_telefono`, `cliente_direccion`, `cliente_empleadoid`) VALUES
...
(1, 2580, 'Aguazero', 'Purificadora y llenadora', 9512709562, 'contacto@aguazero.com', 'Oaxaca - Mexico', '0.16');
...
CREATE TABLE `empleado` (
  ...
  `empleado_nombre` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `empleado_curp` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `empleado_usuario` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `empleado_clave` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `empleado_rolnombre` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `empleado` (`empleado_id`, `empleado_nombre`, `empleado_curp`, `empleado_usuario`, `empleado_clave`, `empleado_rolnombre`) VALUES
(1, 'Soporte tecnico', 'FOCM010615HOCLRNA0', 'manu_soporte', '15d76d1dddc61c7e897724615065b890', 1);
