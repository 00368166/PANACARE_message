  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-offset-1 col-md-10 col-sm-12 wow fadeInUp" data-wow-delay="0.3s">
        <h1 class="hometitle" data-wow-delay="0.6s">PANACEA</h1>
        <p class="wow fadeInUp" data-wow-delay="0.9s">Descripcion rapida de que es panacea. Espacio de marketing. <a rel="nofollow" href="">Enlace de facebook</a>. Gracias.</p>
       ...
       <div class="col-md-offset-1 col-md-10 col-sm-12">
        ...
        <form action="#" method="post" class="wow fadeInUp" data-wow-delay="0.8s">
          <div class="col-md-6 col-sm-6">
            <input name="Nombre" type="text" class="form-control" id="name" placeholder="Nombre">
          </div>
          <div class="col-md-6 col-sm-6">
            <input name="Telefono" type="phone" class="form-control" id="phone" placeholder="Telefono">
          </div>
          <div class="col-md-12 col-sm-12">
            <textarea name="Mensaje" rows="6" class="form-control" id="message" placeholder="Mensaje"></textarea>
          </div>
